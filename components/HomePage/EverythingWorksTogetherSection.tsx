    ...
    <section className="bg-white px-6 pb-16 pt-20 text-[#111111] sm:px-8 sm:pb-20 lg:px-12 lg:pt-28">
      <div className="mx-auto max-w-[1599]">
        <div className="text-center w-">
          <h2 className="text-4xl font-[550] leading-tight tracking-[-0.05em] sm:text-5xl lg:text-[56px]">
            Your Business Runs Better When
            <br />
            <span className="text-[#5BAA37]">Everything Works Together</span>
          </h2>

          <div className="mt-9 flex justify-center mt-25">
        ...
        <div className="mt-16 grid items-center gap-12 lg:grid-cols-[minmax(0,320px)_minmax(0,1fr)] lg:gap-16 mt-20">
          <div className="mx-auto w-full max-w-md text-center lg:mx-0 lg:text-left">
            <h3 className="max-w-[50ch] text-4xl  leading-[1.02] tracking-[-0.05em]  lg:text-[44px] font-[50]" >
              The Brain of Your Business
            </h3>

            <p className="mt-5 max-w-[55ch] text-sm leading-6 text-black/65  lg:max-w-[55ch] font-light">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-2 lg:justify-start mt-10 scale-[1]">
          ...
          <div className="relative mx-auto w-full max-w-[760px]">
            ...
            <div className="relative mx-auto w-full max-w-[680px]">
              ...
              <div className="ml-auto w-[90%]   sm:p-3 scale-[1.3] mt-10">
                <Image
                  src="/img/feature.svg"
