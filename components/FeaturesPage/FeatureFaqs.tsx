...
export default function FeatureFaqs() {
  return (
    <section className="bg-white px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-[1920px] px-10">
        <header className="mx-auto max-w-[500px] text-center">
          <p className="text-[22px] font-bold  tracking-[0.12em] text-[#4C9A2A]">
            FAQ
          </p>
          <h2 className="mt-3 text-4xl font-semibold tracking-[-0.04em] text-[#000000] sm:text-[2.5rem]  lg:leading-[1.05]">
            Frequently Asked Questions
          </h2>
          <p className=" mt-4  text-[1.2rem] leading-6 text-[#6A6A65] ">
