...
export default function BannerFeature() {
  return (
    <section
      className="bg-[#FEF0D34D] px-6 py-12 lg:px-20 lg:py-24 border border-[#FEF0D34D] rounded-[2rem] max-w-[100%] mx-auto mt-20 "
    ...
    >
      <div className="mx-auto flex flex-col gap-20 lg:flex-row lg:items-center lg:gap-16"> 
        ...
        <div className="min-w-0 flex-1 space-y-5 max-[60%]">
          <p className="text-md font-semibold uppercase tracking-[0.2em] text-[#DD9F4D] text-start pb-5">
          BRAND IDENTITY
          </p>
          <h2
          ...
          >
           Your Brand, Your Rules, 100% White Label          </h2>
          <p className="max-w-[65%] text-base leading-relaxed text-[#575757]">
          Build trust and authority under your own name. Dukaandar stays invisible so your business identity can shine.
          </p>
          <ul className="space-y-3 pt-1">
            {ITEMS.map((label) => (
              ...
              >
                <span
                  className="flex size-5 shrink-0 items-center justify-center rounded-full bg-[#DD9F4D] text-[10px] leading-none text-white"
                  aria-hidden
                >
                  ✓
                </span>
