...
import Groupbanner from "@/public/src/Groupbanner.png";
...
export default function HeroSection() {
  return (
    <section className="overflow-hidden bg-white pb-50">
      ...
      <div className="mx-auto flex w-[80%] flex-col items-center justify-center gap-10 px-6 sm:px-8 lg:flex-row lg:items-start lg:gap-6 lg:px-12">
        <div className="flex w-full flex-col items-center pt-0 text-center font-semibold lg:w-[70%] lg:items-start lg:pt-25 lg:text-left">
          <p className="mb-4 text-sm font-bold uppercase tracking-[0.15em] text-[#4C9A2A] sm:text-base">
            Build. Sell. Grow with Dukaandar.
          </p>

          <h1 className="mb-5 text-4xl font-bold text-foreground sm:text-5xl lg:text-[55px] lg:leading-[1.1]">
            Powering the
            <br />
          ...
          <p className="mb-8 max-w-[375px] text-sm leading-relaxed text-neutral-500 sm:text-base">
          ...
          <Button
            ...
            href="/waitlist"
            icon={<ArrowIcon />}
            className="mb-10 w-fit shrink-0 whitespace-nowrap"
          >
            Submit a Waitlist
          </Button>
        ...
        <div className="relative flex w-full items-center justify-center">
          <Image
            ...
            height={499}
            priority
            className="mt-3 h-auto w-full max-w-[700px] object-contain drop-shadow-[0_20px_50px_rgba(0,0,0,0.15)]"
          />
        </div>
      </div>
      <a
        href="#"
        className="flex min-h-8 w-full items-center justify-center bg-black px-4 py-2 text-center text-[11px] font-medium text-white sm:text-sm mt-20"
      >
