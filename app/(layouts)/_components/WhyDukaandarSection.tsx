...
import EverythingWorksTogetherSection from "./EverythingWorksTogetherSection";
import FeatureImage from "@/public/src/video.jpg";
      ...
      <section className="-mt-8 bg-white text-[#111111] sm:-mt-10 lg:-mt-16">
        <div className="mx-auto max-w-7xl px-6 py-14 sm:px-8 sm:py-16 lg:px-12 lg:py-20">
          <div className="grid gap-10 lg:grid-cols-[150px_minmax(0,430px)_minmax(0,1fr)] lg:items-start xl:gap-16">
            <div className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-start lg:justify-start lg:pt-10">
              <p className="text-sm font-bold uppercase leading-[1.15] tracking-[-0.02em] text-[#4C9A2A]">
                Why
                <br />
                Dukaandar?
              </p>

              <div className="relative w-full max-w-[270px] overflow-hidden rounded-[20px] shadow-[0_18px_40px_rgba(0,0,0,0.08)] sm:max-w-[200%] lg:mt-65">
                <Image
                  src={FeatureImage}
                ...
                <button
                  ...
                  className="absolute left-1/2 top-1/2 flex h-11 w-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white text-black shadow-lg transition-transform hover:scale-105"
                >
                  <PlayIcon />
                </button>
              </div>
            ...
            <div className="max-w-xl">
              <h2 className="max-w-[15ch] text-4xl font-semibold leading-[1.02] tracking-[-0.05em] sm:text-5xl lg:text-[56px]">
                Built for Modern Merchants
              </h2>

              <p className="mt-6 max-w-[34ch] text-sm leading-6 text-black/55 sm:text-base">
            ...
            <div className="relative mx-auto mt-15 w-full max-w-[460px] lg:pt-14 xl:w-[450px]">
              <div className="aspect-[1.06] overflow-hidden rounded-[2px] sm:rounded-[50px]">
                <Image
                  src="/src/Image.svg"
              ...
              <div className="absolute left-4 top-4 mt-8 sm:left-5 sm:top-1/2 sm:-translate-x-1/3 sm:-translate-y-1/2 lg:-translate-x-[65%]">
                <CircularBadge />
              </div>
            </div>
          </div>
